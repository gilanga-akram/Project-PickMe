...
WebUI.openBrowser('https://admin-pickme.metrodataacademy.id/interview-schedule')
...
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '(.//*[normalize-space(text()) and normalize-space(.)=\'Pick-ME\'])[1]/following::a[2]'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//input[@id=\'date\']'))

String formatTanggal = tanggalYangInginDipilih.format(DateTimeFormatter.ofPattern("04-04-2024"))
