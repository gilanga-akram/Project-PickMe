...
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//input[@id=\'searchInput\']'))

WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//input[@id=\'searchInput\']'), 'Ardian')
