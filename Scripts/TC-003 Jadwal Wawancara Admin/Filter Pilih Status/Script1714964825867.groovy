...
WebUI.openBrowser('https://admin-pickme.metrodataacademy.id/login')
...
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//select[@id=\'status\']'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//select[@id=\'INVITED\']'))