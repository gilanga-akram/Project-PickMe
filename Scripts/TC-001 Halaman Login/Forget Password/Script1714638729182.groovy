...
WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//input[@id=\'username\']'), 'superadmins')

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//input[@id=\'password\']'))

WebUI.setEncryptedText(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//input[@id=\'password\']'), 'RWre1LatvT4nVMTRmyuPdg==')

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//button[@type=\'submit\']'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//a[contains(text(),\'Forgot password?\')]'))
