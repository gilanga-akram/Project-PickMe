...
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//a[@onclick=\'displayData(1)\']'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//a[@onclick=\'displayData(2)\']'))
