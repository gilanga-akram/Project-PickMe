...
WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//span[@id=\'select2-searchSkill-container\']'))

WebUI.setText(new TestObject().addProperty('xpath', ConditionType.EQUALS, '(//input[@type=\'search\'])[2]'), 'creativity')
